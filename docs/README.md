...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-30 22:22:28 UTC<br>状态：成功</p>
</section>
...
<p>今日共推荐6篇论文，均速读完成，无精读篇目。</p>
<p>最值得关注的是基于潜在世界模型的导航策略预测（7.0/10），其次非完整移动机器人控制与智能货运走廊仿真（6.0/10）可作参考。</p>
<p>建议普通读者优先浏览高分文章摘要，后续可尝试精读以掌握具体方法细节。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Predicting Consequences and Reinforcing Navigation Policies with Latent World Models">Predicting Consequences and Reinforcing Navigation Policies with Latent World Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="Scaling-Based Reciprocal Control Barrier Functions for Nonholonomic Mobile Robots">Scaling-Based Reciprocal Control Barrier Functions for Nonholonomic Mobile Robots</span></li><li><span class="dpr-home-dashboard-paper-title" title="Simulating Cognitive Smart Freight Corridors with Agent-Based Models and Reinforcement Learning">Simulating Cognitive Smart Freight Corridors with Agent-Based Models and Reinforcement Learning</span></li></ul>
  </div>
